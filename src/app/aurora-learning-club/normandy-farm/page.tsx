...
import A5 from './animations/a5.json';
import A6 from './animations/a6.json';
import A7 from './animations/a7.json';
import A8 from './animations/a8.json';
import A9 from './animations/a9.json';
import A10 from './animations/a10.json';
import A11 from './animations/a11.json';
import A12 from './animations/a12.json';
import A13 from './animations/a13.json';
import A14 from './animations/a14.json';
import A15 from './animations/a15.json';
    ...
    const fetchMarkdownFiles = async () => {
      ...
      try {
        ...
        const markdownUrls = [
          ...
          {
            url: 'https://raw.githubusercontent.com/Infinite-Fountain/infinite-fountain/main/src/app/aurora-learning-club/normandy-farm/dynamicText/index10.md',
            animationIndex: 10
          },
          {
